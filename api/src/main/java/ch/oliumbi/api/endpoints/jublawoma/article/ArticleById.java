package ch.oliumbi.api.endpoints.jublawoma.article;

import ch.oliumbi.api.autoload.Autoload;
import ch.oliumbi.api.database.Database;
import ch.oliumbi.api.database.Param;
import ch.oliumbi.api.endpoints.jublawoma.article.responses.ArticleAllResponse;
import ch.oliumbi.api.endpoints.jublawoma.article.responses.ArticleByIdResponse;
