...
import {ArticleAllResponse, ArticleByIdResponse} from "../../interfaces/jublawoma/article";
      ...
      <Flex xl={{direction: "column", align: "center", gap: 8}}>
        {
          articleById.data ? (
              <>
                ...
                <Flex xl={{widthMax: "l", width: true, direction: "column", gap: 2}}>
                  <Markdown markdown={JSON.parse(articleById.data.markdown)} api={configuration.api.jublawoma}/>
                </Flex>
              </>
          ) : null
        }
