          ...
          <Grid xl={{columns: 2, gap: 4}} m={{columns: 1}}>
            ...
            <GridItem xl={{columns: 1}}>
              <Flex xl={{height: true, direction: "column", justify: "center", gap: 1}}>
                ...
                <Text type="p">Jungwacht Blauring ist eine Gemeinschaft, in welcher alle akzeptiert sowie respektiert werden.
                  Gemeinsam haben wir Spass.</Text>
              </Flex>
            </GridItem>
            <GridItem xl={{columns: 1}}>
              <Image src="/assets/jublawoma/images/doodles/float.svg" alt="Beitreten" side="width" rounded={false}/>
            </GridItem>
            <GridItem xl={{columns: 1}}>
              <Flex xl={{height: true, direction: "column", justify: "center", gap: 1}}>
                <Text type="h3">Mitbestimmen</Text>
                <Text type="p">Egal ob gross oder klein, jeder darf und soll in der Jungwacht Blauring seine eigenen Ideen
                  und Vorschläge miteinbringen.</Text>
              </Flex>
            </GridItem>
            <GridItem xl={{columns: 1}}>
              <Image src="/assets/jublawoma/images/doodles/meditating.svg" alt="Beitreten" side="width" rounded={false}/>
            </GridItem>
            <GridItem xl={{columns: 1}}>
              <Flex xl={{height: true, direction: "column", justify: "center", gap: 1}}>
                <Text type="h3">Glauben leben</Text>
                <Text type="p">In der Jungwacht Blauring ermöglichen wir den Kindern einen Freiraum, um sich mit persönlichen
            ...
            <GridItem xl={{columns: 1}}>
              <Flex xl={{height: true, direction: "column", justify: "center", gap: 1}}>
                ...
                <Text type="p">Der Fantasie lassen wir in der Jungwacht Blauring freien Lauf und entwickeln so unsere
                  Fähigkeiten weiter.</Text>
              </Flex>
            </GridItem>
            <GridItem xl={{columns: 1}}>
              <Image src="/assets/jublawoma/images/doodles/plant.svg" alt="Beitreten" side="width" rounded={false}/>
            </GridItem>
            <GridItem xl={{columns: 1}}>
              <Flex xl={{height: true, direction: "column", justify: "center", gap: 1}}>
                <Text type="h3">Natur erleben</Text>
                <Text type="p">Eine beachtliche Zeit verbringen wir in der Jungwacht Blauring in der Natur. Wir lernen, wie
                  wir uns in der Natur verhalten und wie mit ihr bewusst umzugehen. Ausserdem entdecken wir bei jedem
          ...
          <Grid xl={{columns: 2, gap: 4}} m={{columns: 1}}>
            <GridItem xl={{columns: 1}}>
              <Flex xl={{height: true, direction: "column", justify: "center", gap: 2}}>
                ...
                <Text type="p">Liebe Eltern, ist Ihr Kind mindestens in der 3. Klasse und hat Interesse daran, etwas zu
                  erleben? Dann sind Sie bei uns genau richtig. Wir bieten Ihrem Kind ein abwechslungsreiches
                  Freizeitprogramm mit diversen Höhepunkten. Bei uns steht der Spass an oberster Stelle.</Text>
