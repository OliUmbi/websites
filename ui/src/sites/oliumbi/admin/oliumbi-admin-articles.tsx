...
import {ArticleAllResponse} from "../../../interfaces/oliumbi/admin/article";
...
const OliumbiAdminArticles = () => {

  const articleAll = useApi<PaginationResponse<ArticleAllResponse[]>>(Enviroment.OLIUMBI_ADMIN, "GET", "/article")
  const articleCreate = useApi<MessageResponse>(Enviroment.OLIUMBI_ADMIN, "POST", "/article")
            ...
            articleAll.data ? (
                <>
                  <Flex xl={{direction: "row", align: "center", justify: "between", gap: 2}}>
                    <Button onClick={create} highlight={true}>Create</Button>
...
export default OliumbiAdminArticles
