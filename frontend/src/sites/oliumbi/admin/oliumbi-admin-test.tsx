          ...
          <Grid xl={{columns: 3, gap: 4}} m={{columns: 1, gap: 2}}>
            <GridItem xl={{span: 2}} m={{span: 1}}>
              <Carousel>
                ...
                <Image src="https://img-cdn.pixlr.com/image-generator/history/65bb506dcb310754719cf81f/ede935de-1138-4f66-8ed7-44bd16efc709/medium.webp" alt="image" side="both" rounded={true}/>
                <Image src="https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885_640.jpg" alt="image" side="both" rounded={true}/>
                <Image src="https://img.freepik.com/free-photo/colorful-design-with-spiral-design_188544-9588.jpg?size=626&ext=jpg&ga=GA1.1.2008272138.1722643200&semt=sph" alt="image" side="both" rounded={true}/>
